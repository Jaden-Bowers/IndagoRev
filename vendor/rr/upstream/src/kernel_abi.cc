...
// Indago build compatibility (2026-09-07): glibc 2.43 removed the legacy
// termio declaration. Keep rr's ABI size assertion against the Linux UAPI,
// without mixing its termios/winsize declarations into the libc namespace.
#if defined(__GLIBC__) && __GLIBC_PREREQ(2, 43)
namespace indago_linux_legacy_uapi {
#include <asm/termios.h>
}
using termio = indago_linux_legacy_uapi::termio;
#endif

...
#define SYMFLAG_FLATMAPPED          0x08000000
#define SYMFLAG_CF_DEPENDENT        0x10000000
...
typedef enum {
    ...
    SYMOPT_EX_ENABLE_NEGATIVE_AUTH_CACHE_FEATURE, // Enables or disables the the negative authentication cache feature
...
#ifdef IMAGEHLP_ALL_INTERFACE_DEFINITIONS

#ifndef _IMAGEHLP_INTERFACE_DEFINITIONS_
#define _IMAGEHLP_INTERFACE_DEFINITIONS_

#include <stdarg.h>
#include <objbase.h>


#endif // _IMAGEHLP_INTERFACE_DEFINITIONS_

#endif // IMAGEHLP_ALL_INTERFACE_DEFINITIONS

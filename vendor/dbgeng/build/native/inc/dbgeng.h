...
// If this flag is set, the source of command
// execution is an LLM (Large Language Model).
#define DEBUG_EXECUTE_LLM  0x00001000
...
// Client MCP tools have changed. Argument is
// always DEBUG_ANY_ID and MCP tools must be
// explicitly queried
#define DEBUG_CES_MCPTOOLS 0x00020000
// Client MCP prompts have changed. Argument is
// always DEBUG_ANY_ID and MCP prompts must be
// explicitly queried
#define DEBUG_CES_MCPPROMPTS 0x00040000

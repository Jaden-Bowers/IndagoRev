...
const r=spawnSync(exe,['capabilities'],{encoding:'utf8',timeout:60000,maxBuffer:4*1024**2,windowsHide:true});
...
const manifest={schema:'indago.build-capabilities.v1',profile,passed:missing.length===0,missing,
 executable_sha256:crypto.createHash('sha256').update(fs.readFileSync(exe)).digest('hex'),
